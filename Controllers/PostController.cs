    ...
    public class PostController : ControllerBase
    {
        ...
        public IEnumerable<Post> GetPosts(int postId = 0, int userId = 0, string searchParam = "None")
        {
            ...
            if (postId != 0)
            {
                ...
                sqlParameters.Add("@PostIdParamter", postId, DbType.Int32);
            }
        ...
        // User.FindFirst("userId")?.Value is used to retrieve the value of a 
        //   claim named "userId" from the current users's claims
        [HttpGet("MyPosts")]
        ...
        [HttpPut("InsertUpdatePost")]
        public IActionResult InsertUpdatepost(Post postToUpsert)
        {
            string sql = @"EXEC TutorialAppSchema.spPosts_UpdateInsert
            ...
            throw new Exception("Fail to insert/update the post");
        }
